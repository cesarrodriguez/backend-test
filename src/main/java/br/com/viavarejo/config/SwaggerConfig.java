...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("br.com.viavarejo.controller")).paths(PathSelectors.any())
	...
	private ApiInfo metaData() {
		return new ApiInfoBuilder().title("BACKEND TEST REST API")
				.description("\"Spring Boot REST API for calculate installment\"").version("1.0.0")
